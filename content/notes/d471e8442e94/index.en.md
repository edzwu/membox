...
tldr = "A lightweight Hugo-based blog evolving from human-readable to Agent-native. Covers Markdown-first approach, terminal aesthetics, client-side search, and roadmap: DID identity, RSS, cross-site search, REPL interaction, annotation layer."
tags = ["agent"]
+++
