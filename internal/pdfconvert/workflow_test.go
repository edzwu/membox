...
func (f *fakeClient) Convert(_ context.Context, serverURL, filename string, body io.Reader) (RemoteResult, error) {
...
func TestWorkflowPublishesStructuredBookAsLinkedChapterDocuments(t *testing.T) {
	...
	if index.filename != "pdf-019ffe58b0af7b65baf12b7d9c066b19.md" || strings.Contains(index.body, "intro\n") || !strings.Contains(index.body, "chapter-001.md") {
