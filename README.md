...
Press `t` to toggle whether selection notes (`*-note.md`) appear in the list; the preference persists as the `hide notes` setting (also in the settings panel via `ctrl+o`).
